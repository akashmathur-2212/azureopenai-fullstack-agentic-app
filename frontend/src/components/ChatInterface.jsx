...
import logo from "../assets/FinalBlueGEN.png";
import splashLogo from "../assets/logo.jpg";
import brandLogo from "../assets/company_logo.jpg";
...
const ChatInterface = () => {
  ...
  const [redFlagText, setRedFlagText] = useState(""); // for the string
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center" }}>
                  <span className="copy-wrapper">
                    <button
                      ...
                      aria-label="Open red flags"
                    >
                      🚩
                    </button>
                    <span className="tooltip">Show Red Flags</span>
                  </span>
                </div>
              )}
              ...
              {showRedFlagModal && (
                <div className="modal-overlay" onClick={() => setShowRedFlagModal(false)}>
                  <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                    <div className="modal-header">
                      ...
                      <div className="modal-header-buttons">
                        <span
                          ...
                          onClick={() => handleCopy(redFlagText, "red-flag")}
                          tabIndex={0} // for accessibility
                          role="button"
                          aria-label="Copy red flags text"
                          onKeyDown={(e) => e.key === "Enter" && handleCopy(redFlagText, "red-flag")}
                        >
                          <img src={copyIcon} alt="Copy" className="copy-icon" style={{ width: "20px", height: "20px" }} />
                          <span className="tooltip">{copiedIndex === "red-flag" ? "Copied!" : "Copy"}</span>
                        </span>
                    ...
                    <div className="modal-text-with-copy">
                      <div
                        className="modal-text"
                        dangerouslySetInnerHTML={{
                          __html: DOMPurify.sanitize(intelligentFormatToHTML(redFlagText)),
                        }}
                      />

                    </div>

                    <button className="close-button" onClick={() => setShowRedFlagModal(false)}>
                      Close
                    </button>
                  </div>
                </div>
                ...
                <div className="welcome-message">
                  <div className="welcome-flex">
                    ...
                    <div className="welcome-text">
                      <h2>Welcome! I'm your AI-powered Assistant</h2>
                      <p>I can help you to:</p>
                      <ul>
                        <li>Extract and summarize technical and commercial requirements from client request documents</li>
                      ...
                      <ul>
                        ...
                        <li>Can you tell me the historical coverage for &lt;topic&gt;?</li>
                        <li>Can you check the historical submisions for &lt;topic&gt;?</li>
                      </ul>
                    </div>
                  </div>
                </div>
                    ...
                    <div key={idx} className="chat-response">
                      ...
                      <div className="message user-message">
                        ...
                        <div className="message-text-container">
                          ...
                          <span className="copy-wrapper" onClick={() => handleCopy(res.query, `user-${idx}`)}>
                      ...
                      <div className="message ai-message">
                        ...
                        <div className="message-text-with-icon">
                          ...
                          />
                          <span className="copy-wrapper" onClick={() => handleCopy(res.response, `user-${idx}`)}>
                            <img src={copyIcon} alt="Copy" className="copy-icon" />
                            <span className="tooltip">
                              {copiedIndex === `user-${idx}` ? "Copied!" : "Copy"}
                            </span>
          ...
          {toc && rightSidebarOpen && (
            <div className="right-sidebar">
              ...
              <div className="welcome-message">
                ...
                <ul>
                  {[
                    "Can you tell me the requirements related to <topic>?",
                    "Can you list down all the requirements related to <topic>?",
                    "Can you tell me the historical coverage for <topic>?",
                    "Can you check the historical submisions for <topic>?"
                  ].map((prompt, idx) => (
                    <li key={idx} className="example-prompt-item">
                      <span className="prompt-text-with-icon">
                        {prompt}
                        <span
                          className="copy-wrapper"
                          onClick={() => {
                            navigator.clipboard.writeText(prompt);
                            setCopiedIndex(idx); // Optional feedback
